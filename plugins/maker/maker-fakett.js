...
const handler = async (m, { fukusima, text, command, prefix }) => {
  if (!text) {
  ...
  let ppUrl = await fukusima.profilePictureUrl(m.sender, 'image').catch(() => 'https://telegra.ph/file/2f61d40b7cfb440f3cfa7.jpg')
